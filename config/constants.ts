...
export const API_URL = process.env.EXPO_PUBLIC_API_URL || 'https://pomo-co.work'
...
export const SOCKET_URL = process.env.EXPO_PUBLIC_SOCKET_URL || 'https://ws.pomo-co.work'
